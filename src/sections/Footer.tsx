...
function Footer() {
  ...
  useEffect(() => {
    fetch("https://api.github.com/heza-ru/Portfolio")
  ...
  return (
    <footer>
      <Link
        href="https://github.com/heza-ru/Portfolio"
        target="_blank"
        className="footer-link"
      >
        <span className="footer-info">Designed and Built by Mohammad Haider.</span>
        {githubInfo && (
